...
def find_c(target_img1, target_label1, images, labels, c_list, SD_0, organ_id, xlim=[300, 190], ylim=[300, 190], plot_dice=True):
    dice_list = []
    a=50
...
def find_k(target_img1, target_label1, images, labels, k_list, c, SD_0, organ_id, df, xlim=[300, 190], ylim=[300, 190], plot_dice=True):
...
def find_w(target_img1, target_label1, images, labels, w_list, k, c, SD_0, organ_id, df, xlim=[300, 190], ylim=[300, 190], plot_dice=True):
...
def find_ismax(target_img1, target_label1, images, labels, w, k, c, SD_0, organ_id, df, xlim=[300, 190], ylim=[300, 190], ismax=False, plot_dice=True):
    print("SD: " + str(c) + "*[1.7, 2, 2.5]")
    print("k: " + str(k))
    dice_list = []
    a=50
...
def different_slices(images, labels, roi_number, SD_0, k, w, organ_id, ismax=False, xlim = [200, 300], ylim = [300, 200], plot=True):
    a=50
    voxelsize = np.array([0.976562, 0.976562, 2.5])
    circles = 3
    seed=123
